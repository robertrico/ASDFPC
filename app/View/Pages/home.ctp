...
<div class="col-md-6">
	<div class="panel panel-default">
        ...
        <p>Guessing Game</p>
         <p>Another program required by Programming Logic and Methodolgy I was a program designed to guess a number that the user was thinking.</p>
          <li><a href="<?php echo $this->webroot; ?>files/sWareEx/guessGame.java">Main Class</a></li></br>
        <p>Java Graphics</p>
         <p>For my Programming Logic and Methodolgy I, I created a very basic visual graphics assortment.<br/></p>
